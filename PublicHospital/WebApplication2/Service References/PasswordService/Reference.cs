...
namespace WebApplication2.PasswordService {
    ...
    public interface IPasswordService {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(WebApplication2.PasswordService.PasswordFault), Action="http://tempuri.org/IPasswordService/authenticatePersonPasswordFaultFault", Name="PasswordFault", Namespace="http://schemas.datacontract.org/2004/07/ServiceLayer")]
        WebApplication2.PasswordService.authenticatePersonResponse authenticatePerson(WebApplication2.PasswordService.authenticatePersonRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPasswordService/authenticatePerson", ReplyAction="http://tempuri.org/IPasswordService/authenticatePersonResponse")]
        System.Threading.Tasks.Task<WebApplication2.PasswordService.authenticatePersonResponse> authenticatePersonAsync(WebApplication2.PasswordService.authenticatePersonRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IPasswordServiceChannel : WebApplication2.PasswordService.IPasswordService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PasswordServiceClient : System.ServiceModel.ClientBase<WebApplication2.PasswordService.IPasswordService>, WebApplication2.PasswordService.IPasswordService {
        ...
        WebApplication2.PasswordService.authenticatePersonResponse WebApplication2.PasswordService.IPasswordService.authenticatePerson(WebApplication2.PasswordService.authenticatePersonRequest request) {
        ...
        public string[] authenticatePerson(string login, string password, ref string message) {
            WebApplication2.PasswordService.authenticatePersonRequest inValue = new WebApplication2.PasswordService.authenticatePersonRequest();
            inValue.login = login;
            inValue.password = password;
            inValue.message = message;
            WebApplication2.PasswordService.authenticatePersonResponse retVal = ((WebApplication2.PasswordService.IPasswordService)(this)).authenticatePerson(inValue);
            message = retVal.message;
            return retVal.authenticatePersonResult;
        }
        
        public System.Threading.Tasks.Task<WebApplication2.PasswordService.authenticatePersonResponse> authenticatePersonAsync(WebApplication2.PasswordService.authenticatePersonRequest request) {
