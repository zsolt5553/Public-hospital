...
namespace WebApplication2.PasswordServiceRef {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="PasswordServiceRef.IPasswordService")]
    public interface IPasswordService {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(WebApplication2.PasswordServiceRef.PasswordFault), Action="http://tempuri.org/IPasswordService/authenticatePersonPasswordFaultFault", Name="PasswordFault", Namespace="http://schemas.datacontract.org/2004/07/ServiceLayer")]
        WebApplication2.PasswordServiceRef.authenticatePersonResponse authenticatePerson(WebApplication2.PasswordServiceRef.authenticatePersonRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPasswordService/authenticatePerson", ReplyAction="http://tempuri.org/IPasswordService/authenticatePersonResponse")]
        System.Threading.Tasks.Task<WebApplication2.PasswordServiceRef.authenticatePersonResponse> authenticatePersonAsync(WebApplication2.PasswordServiceRef.authenticatePersonRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IPasswordServiceChannel : WebApplication2.PasswordServiceRef.IPasswordService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PasswordServiceClient : System.ServiceModel.ClientBase<WebApplication2.PasswordServiceRef.IPasswordService>, WebApplication2.PasswordServiceRef.IPasswordService {
        ...
        WebApplication2.PasswordServiceRef.authenticatePersonResponse WebApplication2.PasswordServiceRef.IPasswordService.authenticatePerson(WebApplication2.PasswordServiceRef.authenticatePersonRequest request) {
        ...
        public int[] authenticatePerson(string login, string password, ref string message) {
            WebApplication2.PasswordServiceRef.authenticatePersonRequest inValue = new WebApplication2.PasswordServiceRef.authenticatePersonRequest();
            inValue.login = login;
            inValue.password = password;
            inValue.message = message;
            WebApplication2.PasswordServiceRef.authenticatePersonResponse retVal = ((WebApplication2.PasswordServiceRef.IPasswordService)(this)).authenticatePerson(inValue);
            message = retVal.message;
            return retVal.authenticatePersonResult;
        }
        
        public System.Threading.Tasks.Task<WebApplication2.PasswordServiceRef.authenticatePersonResponse> authenticatePersonAsync(WebApplication2.PasswordServiceRef.authenticatePersonRequest request) {
